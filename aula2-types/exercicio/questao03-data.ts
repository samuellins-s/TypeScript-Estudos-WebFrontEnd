...
let subtracao_datas: number = data.getTime() - data_inicio_ano.getTime() // aqui está em milisegundos
let dias_passados: number = subtracao_datas / (1000 * 60 * 60 * 24) // milisegundos para dias
